    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i1 = new Intent(MainActivity.this, AllZodiacsActivity.class);
                startActivity(i1);
            }

        });
       /* Button capricorn_button = (Button) findViewById(R.id.capricorn_button);
        capricorn_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i2;
                i2 = new Intent(AllZodiacsActivity.this, CapricornActivity.class);
                startActivity(i2);
            }
        });
        ...
        Button libra_button = (Button) findViewById(R.id.libra_button);
        libra_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i11 = new Intent(AllZodiacsActivity.this, LibraActivity.class);
                startActivity(i11);
            }
        });
        ...
        Button sagittarius_button = (Button) findViewById(R.id.saggitarius_button);
        sagittarius_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i13 = new Intent(AllZodiacsActivity.this, SagittariusActivity.class);
                startActivity(i13);
            }
        }); */
    }
